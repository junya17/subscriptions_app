...
class SpotifiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create spotify' do
    assert_difference('Spotify.count') do
      post spotifies_url, params: { spotify: { issue_date: @spotify.issue_date, memo: @spotify.memo, price: @spotify.price, status: @spotify.status, update_period: @spotify.update_period } }
    end
  ...
  test 'should update spotify' do
    patch spotify_url(@spotify), params: { spotify: { issue_date: @spotify.issue_date, memo: @spotify.memo, price: @spotify.price, status: @spotify.status, update_period: @spotify.update_period } }
